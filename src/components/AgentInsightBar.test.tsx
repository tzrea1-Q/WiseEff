        ...
        items={[
          {
            ...
            tone: "warning",
            headline: "有 2 个高风险孤儿参数",
            actions: [{ id: "view", label: "查看孤儿参数", onClick: onAction }]
          }
        ]}
      />
    );

    expect(screen.getByText(/高风险孤儿参数/)).toBeInTheDocument();
    fireEvent.click(screen.getByRole("button", { name: "查看孤儿参数" }));
