                ...
                <>
                  <div>
                    ...
                    <dd>
                      ...
                      {sourcePreview.reason && !(canSubmitBatchReview && sourcePreview.reason === "canonical-batch-writer-unavailable")
              ...
              <div className="configuration-workbench__inspector-actions">
                ...
                {sourcePreview?.kind === "canonical" ? (
                  <button
                    ...
                    title={!(canSubmitSourceReview || canSubmitBatchReview) ? sourceReviewReason(sourcePreview.reason) : undefined}
                    onClick={onSubmitSourceReview}
                  >
                    {submittingSourceReview ? "提交中…" : canSubmitBatchReview ? "提交 JSON 批量审核" : "提交来源变更审核"}
                  </button>
                ) : null}
                {canAbandon ? (
