...
export function scoreHotspotGroup(input: ScoreInput, profile: WindowProfile) {
...
export function mapHotspotStatus(highRiskCount: number, score: number): { label: string; level: "watch" | "elevated" | "normal" } {
