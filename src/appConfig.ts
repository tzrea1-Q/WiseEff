  ...
  switch (page.key) {
    ...
    case "parameter-admin":
      return {
        ...
        contextSummary: "正在关注批量导入、权限范围、电池参数健康度和审计留痕。",
        prompts: ["检查导入风险", "汇总权限矩阵", "查看审计异常"],
        actions: [
          { id: "import-parameters", label: "模拟批量导入", requiresConfirm: true },
          { id: "audit-scan", label: "生成审计摘要", requiresConfirm: false }
        ]
      };
    case "log-admin":
      return {
