...
- DTS reload debugging requires `debugging:dts-reload`. Sensitive-node matches escalate as documented above (`parameter:edit-critical`, and `confirm-sensitive-reload` for critical).
