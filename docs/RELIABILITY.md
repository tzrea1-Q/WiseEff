...
- `/metrics` keeps the compatibility `wiseeff_agent_provider_ready` gauge for Xiaoze LLM readiness. Model ids stay in readiness JSON and traces rather than Prometheus labels.
