...
- `exec-plans/active/2026-08-18-property-key-source-cutover.md`: plan + preview via #544; start + finalize via #549 (migration `0113`). **TD-117 stays Open.** Prepare does not stage drafts/CRs; no start-job UI. Do not enable inline rename while `referenceCount > 0`.
