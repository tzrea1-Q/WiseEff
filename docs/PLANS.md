...
- `exec-plans/active/2026-09-12-catalog-authoring-publication.md`: in-product Catalog definition authoring and online publication (ADR-0043). CP-00/CP-01 documentation freeze is in progress on Scratch `docs/catalog-authoring-publication-cp00`. Host Artifact adoption is blocked until authorized read-only evidence exists. This program does not reopen the frozen Wayfinder #668 node graph, does not bundle #824, and is not production enablement.
