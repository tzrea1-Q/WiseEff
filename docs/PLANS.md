...
- `exec-plans/active/2026-08-22-deterministic-tech-debt-parallel-closeout.md`: parallel no-hardware closeout for TD-059 dialog convergence, TD-071 server seed-test harness cleanup, and TD-073 frontend test-harness completion. Shared tracker/plan edits land only after the three isolated implementation PRs.
