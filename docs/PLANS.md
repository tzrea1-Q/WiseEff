...
- [Project review role governance](exec-plans/active/2026-09-15-project-review-role-governance.md): proposed scoped role configuration, safe organization-role updates and a complete parameter review workflow; planning only, implementation not started.
