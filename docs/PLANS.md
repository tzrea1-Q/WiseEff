...
- `exec-plans/active/2026-08-18-self-hosted-setup-wizard.md`: OpenClaw/Hermes-style TTY setup wizard — ask only human decisions, generate secrets, section reconfigure, doctor. Design only until the IP lab profile (PR #534) is available.
