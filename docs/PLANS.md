...
- `exec-plans/active/2026-08-07-project-configuration-workbench-structured-edit.md`: Issue #233 Structured DTS edit sessions in source context — typed inspector, session-changes dock, subset submit via existing CR flow, permission lock (branch `feat/project-configuration-workbench-structured-edit`).
