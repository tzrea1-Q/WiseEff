...
- `exec-plans/active/2026-08-22-deterministic-tech-debt-parallel-closeout-wave-2.md`: parallel no-hardware closeout for TD-018 Xiaoze contracts, TD-077 style-test contracts, TD-109 DTS reload promotion parity, and TD-114 review action-panel layout residue. Four isolated implementation PRs land before shared tracker/archive edits.
...
- `exec-plans/active/2026-08-17-launch-actionable-tech-debt-closeout.md`: launch-window closeout of tracker rows that do not need HDC, expert logs, or a target environment. Batch 1 archived attribution evidence and moved `2026-08-01-attribution-deferred-implementation.md` to `completed/`; Batch 2 closed TD-056 (parameter-file rollback / display name); Batch 3 landed on `main` — TD-057 via #513, TD-079 hierarchical-modules via #511, import-wizard via #512. Batch 4 landed 2026-08-18: workbench fixtures #516, semantic file-sync #519, dts-reload handoff/shapes #517, DTO validation #515, render harness #518, governance ADRs #520. **TD-079 closed** on `fix/td-079-flip-ci-acceptance` (shared CI acceptance is post-cutover). TD-082 closed on `main` via #507. Wave 2 H–N (2026-08-18): TD-013 closed via #529, TD-066 closed via #531; TD-014 / TD-075 / TD-097 / TD-112 remain **partially** open (dts-reload grid via #550). The deterministic closeout then closed TD-071 via #575, TD-073 via #576, and TD-059 via #577; the reload workflow sheet remains outside TD-059.
