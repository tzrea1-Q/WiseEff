...
- `exec-plans/active/2026-08-07-project-configuration-workbench-inspector-history.md`: Issue #230 context inspector, immutable file history, source history/diff modes, and PCW-D15 overlay persistence (branch `feat/project-configuration-workbench-inspector-history`).
