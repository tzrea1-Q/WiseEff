...
- `exec-plans/completed/2026-08-27-xiaoze-draggable-launcher.md`: completed desktop/tablet draggable Xiaoze launcher; closed-state dragging avoids toggle activation, and open-state launcher dragging moves the launcher and popup as one viewport-clamped group while preserving mobile full-screen behavior.
