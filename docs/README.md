...
6. [Runbooks](runbooks/README.md): manual acceptance, self-hosted runtime, self-hosted release/rollback, staging, backup/restore, rollback, monitoring, HDC, Agent provider, and pilot operations.
