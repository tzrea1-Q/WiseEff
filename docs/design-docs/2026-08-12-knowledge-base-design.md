...
1. Related-knowledge recommendations on log-analysis results (similarity search from conclusion text). — **Shipped 2026-08-13** via [`2026-08-13-knowledge-log-recommendations.md`](../exec-plans/active/2026-08-13-knowledge-log-recommendations.md): `GET /api/v1/knowledge/related-to-log` plus the log result page's related-knowledge section.
