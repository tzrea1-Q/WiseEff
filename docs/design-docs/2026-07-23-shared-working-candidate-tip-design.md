...
> Chinese: [`docs/zh-CN/design-docs/2026-07-23-shared-working-candidate-tip-design.md`](../zh-CN/design-docs/2026-07-23-shared-working-candidate-tip-design.md)  
...
- Spec lives here; implementation plan under `docs/exec-plans/active/` (and zh-CN if mirrored) after this file is approved for planning.
