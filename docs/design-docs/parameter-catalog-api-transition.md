...
Issue #673 had no accepted result to consume at the time of this decision. The HTTP contract therefore names required external capabilities without inventing the internal kernel interface or transaction names.
