...
> 日期：2026-07-23  
> 状态：设计已批准，待实现计划  
> English: [`docs/design-docs/2026-07-23-shared-working-candidate-tip-design.md`](../../design-docs/2026-07-23-shared-working-candidate-tip-design.md)  
...
- 本文件为设计真相；实现计划在本文件获准进入规划后写入 `docs/exec-plans/active/`（及对应 zh-CN 镜像）。
