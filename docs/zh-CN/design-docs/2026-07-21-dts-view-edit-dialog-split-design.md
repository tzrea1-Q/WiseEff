...
> 日期：2026-07-21  
> 状态：设计已批准，待实现计划  
> English: [`docs/design-docs/2026-07-21-dts-view-edit-dialog-split-design.md`](../../design-docs/2026-07-21-dts-view-edit-dialog-split-design.md)  
...
托盘「本轮已修改」对值变更同样使用行级 `ParameterValueDiff`；不展示 candidate/draft/binding/spec 技术身份。
