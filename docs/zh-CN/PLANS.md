...
- `exec-plans/active/2026-08-16-frontend-runtime-follow-up.md`：app-shell 收口后的架构审查余项——第一批 #474–#476、第二波 #478/#479/#481 与目录诚实 #480 已在 `main`。收口：TD-109 `Object.assign` 余量、配置工作台 CSS、节点调试 session 后接 C5 `BridgeGateway`、mock 播种（中文全文 `docs/zh-CN/exec-plans/active/2026-08-16-frontend-runtime-follow-up.md`）。
