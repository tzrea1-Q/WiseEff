...
- `exec-plans/active/2026-08-16-frontend-runtime-follow-up.md`：app-shell 收口后的架构审查余项——D/E/F/H 已在 `main`（#483–#486）；剩余 Track G C5 共享 bridge/target/protocol 类型（中文全文 `docs/zh-CN/exec-plans/active/2026-08-16-frontend-runtime-follow-up.md`）。
