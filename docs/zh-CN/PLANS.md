...
- `exec-plans/active/2026-08-09-pcw-workbench-shell-wave-2.md`：PCW 壳层 wave-2——先抽 Inspector + CommandBar 展示适配器，再抽 ConfigSetOpsSession；中间目标壳 ≤ ~2500 行；等 PR #266 合入后从 `main` 开分支 `feat/pcw-workbench-shell-wave-2`。
