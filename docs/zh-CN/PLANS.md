...
- `exec-plans/active/2026-08-09-pcw-workbench-shell-wave-3.md`：PCW 壳层 wave-3——Navigation / WorkspaceLoad / CanvasHistory / Activity Workbench session；软门禁壳 ≤ ~1500 后关 #258（分支 `feat/pcw-workbench-shell-wave-3`）。
