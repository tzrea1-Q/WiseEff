...
- `exec-plans/active/2026-08-16-frontend-runtime-follow-up.md`：app-shell 收口后的架构审查余项——A/B/C 三轨已于 2026-08-16 合入（#474 退役 API 模式演示切片、#475 mock `WiseEffApiError` 信封、#476 日志分析 CSS 同目录）。余量：TD-110 快照/分区/播种、TD-109 第二波领域守卫、C7 第二波参数评审 CSS；C5 桥接网关仍推迟（中文全文 `docs/zh-CN/exec-plans/active/2026-08-16-frontend-runtime-follow-up.md`）。
