...
- `exec-plans/active/2026-07-30-attribution-subjects-and-versioned-specs.md`：归属主体 + 版本化参数定义 —— PR0–PR6 已落地（ADR-0013/0014）；follow-up 与治理 PR 经 #212–#215 合入；残留收口见 `2026-08-01-governance-platform-closeout.md`。
- `exec-plans/active/2026-08-01-governance-platform-closeout.md`：治理/平台收口 —— 归档三份源计划、关闭 TD-054、Platform `PLAT-ROLE-*`/`DRV-PROMOTE-*` 证据、参数治理 Admin 验收 ID；不引入新语义；D1–D8 / D-AG-* 仍开放（分支 `feat/governance-platform-closeout`；中文摘要 `docs/zh-CN/exec-plans/active/2026-08-01-governance-platform-closeout.md`）。
- `exec-plans/completed/2026-07-30-parameter-governance-state-machine-completion.md`：参数管理后台状态机收口已合入（#212–#214；ADR-0011/0012）。残留 → 收口计划；D1–D8 仍在 design-docs。
- `exec-plans/completed/2026-07-31-attribution-governance-follow-up.md`：归属 follow-up PR7–PR9 已合入（#215）。残留 → 收口计划；D-AG-01–04 仍开放（中文对照 `docs/zh-CN/exec-plans/completed/2026-07-31-attribution-governance-follow-up.md`）。
- `exec-plans/completed/2026-07-30-platform-tier-and-super-admin.md`：platform-admin + schema 平台层已合入（#209–#210；ADR-0009）。残留 → 收口计划。
