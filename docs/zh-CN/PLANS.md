...
- `exec-plans/active/2026-07-25-parameter-admin-redesign.md`：参数管理后台产品重设计 —— 以治理作用域为信息架构主轴、项目级路由取代 modal、经拓扑 port 实现 mock/API 对等、identity mapping 治理迁入后台、后台自持状态、旧界面一次性退场（分支 `feat/refactor-parameter-admin`；ADR-0001、ADR-0002；中文对照 `docs/zh-CN/exec-plans/active/2026-07-25-parameter-admin-redesign.md`）。
