...
- `exec-plans/active/2026-08-18-workflow-discovery-visibility.md`：发现面读取可见工作流 allowlist（ADR-0036）。第一次只给参数管理和调试；日志分析和知识库不进侧栏/首页，直达仍可用。实现分支 `cursor/workflow-discovery-visibility-b895`。
