...
- `exec-plans/active/2026-08-27-xiaoze-draggable-modeless-popup.md`：已确认的桌面/平板小泽可拖动、可缩放非模态陪伴浮窗方案，包含浏览器本地布局持久化、键盘/复位恢复、跨路由连续性、业务 modal 层级、手机全屏保留及新的验收/operation evidence。
