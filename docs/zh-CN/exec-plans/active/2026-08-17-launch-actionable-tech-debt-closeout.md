...
卫生与架构余量是真债，但不该抢走上线窗口：TD-003 / TD-012（生成客户端及 generic AG-UI/REST 余量；TD-008、TD-018 已关）、TD-005（已完成计划卫生）、TD-014（#532 导入导出之后的目录余量）、TD-055（治理实现）、TD-067 / TD-068（桥接/安全后续；TD-063 / TD-066 已由 #547 / #531 关闭）、TD-072 / TD-075 / TD-076（测试架构；TD-075 部分），以及 TD-097 / TD-110 / TD-112 / TD-113（前端余量；TD-097 / TD-112 经 #533 / #526 部分关闭）。触及那些表面时再捡；不要捆进本分支。TD-013 已由 #529 关闭；TD-048 / TD-049 / TD-050 / TD-051 / TD-052 / TD-053 / TD-059 / TD-063 / TD-071 / TD-073 / TD-074 / TD-117 均已关闭。TD-059 / TD-071 / TD-073 于 2026-08-22 经 #577 / #575 / #576 收口；reload workflow sheet 不属于 TD-059。第二批确定性收口又经 #580 / #582 / #583 / #585 关闭 TD-109 / TD-018 / TD-077 / TD-114，但没有关闭范围更广的 TD-003/012 或 TD-072/075/076。
...
| 其余开放行（TD-003、TD-005、TD-012、TD-014、TD-055、TD-067–068、TD-072、TD-075–076、TD-097、TD-110、TD-112–113 等） | Open（后续） | 不在本分支。TD-003/012/014/075/097/112 保持**部分**开放。TD-018/077/109/114 已在第二批确定性收口中经 #582/#583/#580/#585 关闭；TD-008/013/048–053/059/063–066/071/073/074/117 此前已关。 |
