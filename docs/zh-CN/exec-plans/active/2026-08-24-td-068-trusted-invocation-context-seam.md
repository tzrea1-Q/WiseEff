...
| 生成物、runbook、前端/设计、references | Updated generated artifact | `docs/generated/db-schema.md` 记录 owner 授权的 0116-0119 字段、约束及 enablement binding 可空身份；`docs/runbooks/`、`src/` 与 `docs/references/` 保持不变。 |
