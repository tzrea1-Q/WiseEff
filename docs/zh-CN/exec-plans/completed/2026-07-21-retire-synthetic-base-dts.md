...
> English: [English](../../../exec-plans/completed/2026-07-21-retire-synthetic-base-dts.md)  
> RFC：[项目主 DTS 契约](../../design-docs/2026-07-21-project-primary-dts-contract-rfc.md)  
> 分步实现：[英文 exec plan](../../../exec-plans/completed/2026-07-21-retire-synthetic-base-dts.md)

- 日期：2026-07-21
- 状态：**已完成**（Phase 3 seed 门禁已在 `main`：已提交 `*-board.dts` 为 SoT；`db:seed:m1` 仅 parse 完整性；CI 中 `dtc:seed:compile` 为 advisory）
