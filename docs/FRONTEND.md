...
- `/parameter-admin` serves organization-scoped governance (specs, reviews, module mappings, bulk import, identity mapping). Project-scoped file/config-set operations live under `/parameter-admin/projects`.
