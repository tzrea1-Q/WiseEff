...
- `/parameter-admin` is the only sidebar entry for parameter admin. In-page tabs switch organization governance vs project operations; project file/config-set routes live under `/parameter-admin/projects`.
