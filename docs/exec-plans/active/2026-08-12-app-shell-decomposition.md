...
- **Status:** Active — Wave 1 landed (`34305cc9`); Wave 2 landed via PR #324; Wave 4 landed on `refactor/extract-feature-pages` (executed before Wave 3: it is a pure verbatim move with no dependency on the composition root, and shrinking the shell first makes the Wave 3 refactor smaller)
