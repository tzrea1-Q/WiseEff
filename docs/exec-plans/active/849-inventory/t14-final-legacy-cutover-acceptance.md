...
Status: **Canonical-only GET restored after seed writer (120 catalog rows per demo project). Scanner leftover 55 remains; T1.4 stays unchecked.** Overlay and governance **detail** stay 2xx. No SEALED.
...
- **TD-125 canonical-only GET restored:** seed writer writes 120 catalog bindings per demo project; GET no longer mixes topology leftovers. Overlay/governance **detail** stay 2xx. T1.4 leftover stays unchecked.
