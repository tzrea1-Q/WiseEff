...
| target-synthetic-acceptance | **passed** on `d520964e4` (historical) and again on closeout `6f8cbd236`. Current: owned HMAC runtime `full-20260920t120007490z-6f8cbd2361f8-391f8bd8` on helper PG **55438**, frontend `http://127.0.0.1:5180`, API `http://127.0.0.1:18800`. Command: `npm run acceptance:browser -- --mode target-non-hdc --no-start-runtime --runtime-descriptor <abs runtime.json> --frontend-url http://127.0.0.1:5180`. Preflight **passed** (`non_hdc_local`). Playwright **174 passed / 32 skipped**. Coverage **passed**. Operation evidence **passed** (192 records, invalid none). Artifacts under `test-results/t32-target-synthetic-runtime/full-20260920t120007490z-6f8cbd2361f8-391f8bd8/`. Not Hosted; not production. |
