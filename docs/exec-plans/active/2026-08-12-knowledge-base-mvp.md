...
- [ ] Deferred work recorded in `docs/exec-plans/tech-debt-tracker.md` (closeout — Phase 2 already recorded TD-080: pgvector late-install manual column step + missing pgvector CI coverage)
