...
| Upgrade entry and restart | Existing controller, run-bound initialization, readiness and queue/proxy restoration | Native amd64 terminal apply completed the 126-entry source admission, backup stage, 11 migrations, unpublished initialization and candidate app readiness. It failed the final proxy probe; full acceptance and restart remain pending. Local ARM guard is retained. |
