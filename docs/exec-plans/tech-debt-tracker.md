...
| TD-003 | Contracts | API contract is documented but not yet enforced by generated schema/client. | Frontend DTOs and backend responses can drift as endpoints grow. | Introduce OpenAPI or schema generation before broad M1 API work. |
