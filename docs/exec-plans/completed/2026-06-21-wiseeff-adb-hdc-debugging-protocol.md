...
| Planning docs | Update | `docs/exec-plans/completed/2026-06-21-wiseeff-adb-hdc-debugging-protocol.md`, `docs/PLANS.md` | Keep this plan active during implementation; move to completed after verification. |
