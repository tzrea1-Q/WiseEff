...
> Status: PR0–PR6 implementation complete on `main`; remaining decided gaps live in the follow-up plan.  
...
> Follow-up (decided work): [`../completed/2026-07-31-attribution-governance-follow-up.md`](./2026-07-31-attribution-governance-follow-up.md)  
