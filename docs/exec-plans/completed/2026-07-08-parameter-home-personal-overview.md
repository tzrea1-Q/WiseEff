...
**Implemented** on `main` (parameter-home personal overview / hotspot PR).
...
```markdown
**状态**：已实现 — 见 [2026-07-08-parameter-home-personal-overview.md](./2026-07-08-parameter-home-personal-overview.md)
```
...
Plan saved to `docs/exec-plans/completed/2026-07-08-parameter-home-personal-overview.md`.
