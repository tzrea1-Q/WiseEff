...
| `WISEEFF_SEED_LEGACY_FLAT_IDENTITY` | unset (`0`) | `db:seed:m1` | Set to `1` to seed dual-track flat defs/PPV without local post-cutover (typed binding submit stays blocked). Default unset/semantic-only runs local post-cutover finalize. |
