...
Public footer owner, version, and contact settings are build-time values. See [Configure the application footer](../../docs/developer/environment-variables.md#configure-the-application-footer) for copyable examples, rebuild requirements, and verification steps.
