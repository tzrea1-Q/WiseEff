...
/**
 * Org-scoped mutations (activate draft / deprecate / restore) must target an org-owned row.
 * Global specs (organization_id IS NULL) require platform-admin via requireOrgOrGlobalSpec.
 */
