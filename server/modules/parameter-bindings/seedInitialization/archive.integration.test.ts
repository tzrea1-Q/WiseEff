...
describe("legacy parameter plane archive", () => {
  ...
  it("keeps an exact inventory of foreign-key references outside the captured plane", async () => {
    ...
    expect(references.rows).toEqual([
      ...
      { child: "parameter_catalog.project_source_member_tombstones", parent: "public.dts_config_revisions", delete_action: "RESTRICT", constraint_count: "1" },
    ...
    expect(triggers.rows).toEqual([
      ...
      { relation: "public.project_parameter_value_change_requests", trigger_name: "project_parameter_value_change_request_member_ck", function_name: "parameter_catalog.assert_member_removal_request" },
      { relation: "public.project_parameter_value_change_requests", trigger_name: "project_parameter_value_change_request_member_immutable", function_name: "parameter_catalog.protect_member_removal_request" },
