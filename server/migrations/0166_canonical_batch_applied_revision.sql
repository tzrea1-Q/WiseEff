-- #906 C forward repair of the applied 0165 deferred assertion. The target's
-- config_revision_id is its frozen BASE revision; a committed Value belongs to
-- the NEW source revision proved by its applied pin and receipt. Keep 0165
-- byte-for-byte unchanged and preserve all other target/result checks.
