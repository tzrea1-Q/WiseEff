...
const allowedWiseEffMetricNames = new Set([
  ...
  "wiseeff_build_info",
  "wiseeff_config_publish_results_total",
  "wiseeff_database_ready",
  "wiseeff_dependency_health",
  "wiseeff_device_gateway_operations_total",
  "wiseeff_dts_pipeline_duration_ms_count",
  "wiseeff_dts_pipeline_duration_ms_sum",
  "wiseeff_dts_pipeline_failures_total",
  "wiseeff_dts_toolchain_info",
  "wiseeff_dts_toolchain_ready",
  ...
  "wiseeff_identity_mapping_tasks_open",
  ...
  "wiseeff_parameter_spec_review_tasks_open",
