...
const suites: Record<string, { image: string; files: readonly string[]; config: string; command?: "schema-doc" }> = {
  ...
  "authority-pg16": { image: "postgres:16-alpine", files: ["ops/self-hosted/scripts/parameter-catalog-upgrade/deploymentAuthority.integration.test.ts"], config: "vitest.scripts.config.ts" },
